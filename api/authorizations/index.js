...
async function handleDelete(req, res) {
  ...
  await saveHistory(adminDb, String(authorization.advanceId || ""), "REPASSE_EXCLUIDO", "Repasse removido da area do auxiliar.");
...
export default async function handler(req, res) {
  ...
  try {
    ...
    sendError(res, 400, error.message || "Nao foi possivel concluir a operacao do repasse.");
  }
}
